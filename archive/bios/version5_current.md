...
＋ *Building @ NYX*
<br>
＋ *Current mission: { building human-centered systems that enhance cognition & productivity }*

## 🌱 Focus Areas
**Tech | Product | Design | Study + Interests**
<details>
...
- **Study:** computer science, electrical engineering
  - **Interests** - business, cognitive science, neuromorphic engineering, law, etc.
...
- **NeuroWell:** fusing 5+ fields for `accessible learning` and healthcare information
  - Mind & brain: neuroscience, cognitive science, psychology
  - Tech: AI/ML
  - Impact: health, education, accessibility, productivity
- **Figma Plugin:** improving `workflow`
...
- **Cognitive Interfaces:** tool shaped around `human mental models` fusing interaction concepts (cognition-driven UI experiments)

### 🌙 Previous
- **Assistify:** AI intelligent chatbot that improves support workflows responses
- **PantryPilot:** NLP-based recommendation system to process recipes with search system
- **Wellnest:** food inventory management platform
...
- 🤝 **Organizations:** lead and contribute to `30+ organizations` (companies, startups, nonprofits) across tech, business, and design
  - Organize `60+ events, initiatives, and programs` across multiple organizations at the international, national, state, and local level
- 🚀 **Projects:** build and jump start `20+ projects` focused on `tech fields` with `improvement`
  - **Tech + engineering fields** - full-stack development, AI/ML, data science, system design, human-computer interaction (HCI), design engineering, space systems / UX
  - **Product (PM + UI/UX) fields** - product strategy, UI/UX design, interaction design, wireframing and prototyping, user research, usability testing, info architecture, design systems, impact evaluation
